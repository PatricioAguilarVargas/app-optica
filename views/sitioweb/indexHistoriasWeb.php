...
<?= Html::submitButton('GUARDAR', ['class' => 'btn btn-block btn-sistema btn-flat', 'name' => 'guardar-button']) ?>
                ...
                <div data-step="7" data-intro="busca las historias en el sitio web" class="col-md-2">	
...
<?= Html::resetButton('LIMPIAR', ['class' => 'btn btn-block btn-sistema btn-flat', 'name' => 'limpiar-button']) ?>
                ...
                <div class="col-md-2">	
                    <button type="button" class="btn btn-block btn-sistema btn-flat" data-step="1" data-intro="Esta formulario sirve para ingresar las historias que se muestran en el sitio web de la optica" onclick="javascript:introJs().start();">
            ...
            <div class="row">
                <div  class="col-md-12">
                    <div data-step="2" data-intro="Se debe ingresar el nombre de la persona a quien pertenece la historia" class="form-group" >
                        <?= $form->field($model, 'titulo')->textInput(["class" => "form-control", "onkeyup" => "javascript:this.value=this.value.toUpperCase();", "placeholder" => "Nombre del cliente", "required" => true, "maxlength" => "50", "size" => "50"])
            ...
            <br>	
            <div class="row">
                <div data-step="4" data-intro="Se debe seleccionar la foto relacionada con la hitoria" class="col-md-12">
                    <div class="form-group">
    ...
    <div class="modal-dialog" style="width: 80% !important;" >
        ...
        <div class="modal-content">
            <div class="modal-header headModal">
                <h4 class="modal-title text-center">BUSCAR HISTORIAS WEB</h4>
            </div>
